        ...
        <div class="part1">
            ...
            <div class="price">&#165 <?php
                ...
                if($aid==-1){
                    ...
                    $daddressquery=mysqli_query($conn,"select usertoaddress.address1,usertoaddress.address2 from users,usertoaddress where users.id=usertoaddress.uid and usertoaddress.id=$aid and users.id=$usid and valid=1 limit 1");
                    while($daddressrow=mysqli_fetch_row($daddressquery)){
                        $address=$daddressrow[0].$daddressrow[1];
                        $addressfetched=1;
                    }
